...
import 'package:ui_libraries/calendar/calendarro_page.dart';
import 'package:ui_libraries/calendar/date_range.dart';
import 'package:ui_libraries/calendar/default_weekday_labels_row.dart';
import 'package:ui_libraries/calendar/date_utils.dart';
import 'package:ui_libraries/calendar/default_day_tile_builder.dart';
...
typedef void NextPageCallback(DateTime pageStartDate);
...
class Calendarro extends StatefulWidget {
  ...
  NextPageCallback nextPageSelected;
  ...
  void setCurrentPage(DateTime date) {
    state.setCurrentPage(date);
  }
